...
fvs = FileVideoStream('solidWhiteRight.mp4').start()
time.sleep(1.0)
...
# cap=cv2.VideoCapture('http://10.11.239.64:8081/video.cgi?.mjpg')
# fps = int(cap.get(cv2.CAP_PROP_FPS))

# cap = cv2.VideoCapture('G:\\AI\\fifa18\\lane_tracker-master\\test_images\\test7.jpg')
# fps = int(cap.get(cv2.CAP_PROP_FPS))
# print(fps)
# i=0
# # while cap.isOpened():
...
# 	# stream = urllib.request.urlopen('http://10.11.239.64:8081/frame.mjpg')
